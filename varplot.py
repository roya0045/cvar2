...
def plotvars(BB):
    ...
    for bb in hol:
        if BB==0:
            ...
            d1=vecvari10(inputcols, wid,noB=0, B=bb,sqrt=sqrtv,verbose=0,sizz=sizz[0])
            d2=vecvari10(inputcols, wid,noB=1, B=bb,sqrt=sqrtv,verbose=0,sizz=sizz[0])#-vecvari10(inputcols, wid,noB=0, B=bb,square=0,sqrt=0,verbose=0)
            p1=vecvari1(inputcols, wid, B=bb,BB=0,sqrt=sqrtv,verbose=0,sizz=sizz[1])
            p2=vecvari1(inputcols, wid, B=bb,BB=1,sqrt=sqrtv,verbose=0,sizz=sizz[1])
        elif BB==1:
            print(bb.shape,bs[9].shape)
            d=vecvari10(inputcols, bb, B=bs[9],sqrt=sqrtv,verbose=0,sizz=sizz[0])
            p=vecvari1(inputcols, bb, B=bs[9],sqrt=sqrtv,verbose=0,sizz=sizz[1])
